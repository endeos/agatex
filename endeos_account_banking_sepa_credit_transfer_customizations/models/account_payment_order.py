...
class AccountPaymentOrder(models.Model):
    ...
    This method has been overriden to edit the file prefix. 
    If it is updated by the OCA mainteiner, this should be updated too
    """
    def generate_payment_file(self):  # noqa: C901
        ...
        gen_args = {
            ...
            "payment_method": "TRF",
            "file_prefix": f"sct_{extra_prefix}",   # THIS IS THE PART MODIFIED <------------------------------------------------------------------------------------------------
